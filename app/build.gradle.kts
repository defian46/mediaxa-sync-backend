...
android {
    namespace = "com.mediaxa.business.suite"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mediaxa.business.suite"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // kotlinx.serialization — JSON payload serialization for SyncQueue
    implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.6.3")

    // EncryptedSharedPreferences — secure DeviceId storage
