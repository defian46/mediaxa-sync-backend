            ...
            Column(
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column {
                            Text(
                                text = "Selamat Bekerja, ${user.username}!",
                                fontSize = 18.sp,
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Halaman POS Utama Kasir",
                            fontWeight = FontWeight.Bold,
                            fontSize = 18.sp
                        )
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(
                            text = "Gunakan tombol di bawah untuk membuka kasir POS atau melihat riwayat transaksi.",
                            fontSize = 13.sp,
