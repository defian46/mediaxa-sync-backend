...
data class TransactionDto(
    ...
    @SerialName("transactionDate") val timestamp: Long,
    @SerialName("cashierUserUuid") val cashierUuid: String,
    val cashierName: String,
    @SerialName("manualDiscount") val discount: Double,
    val subtotal: Double,
    val total: Double,
...
data class TransactionItemDto(
    ...
    val menuUuid: String,
    val menuName: String,
    @SerialName("qty") val quantity: Int,
    @SerialName("sellingPrice") val unitPrice: Double,
    val subtotal: Double,
    @SerialName("costPrice") val hpp: Double,
    val notes: String? = null,
    val updatedAt: Long,
    val isDeleted: Boolean = false
)
...
data class PaymentDto(
    ...
    @SerialName("changeAmount") val changeAmount: Double = 0.0,
